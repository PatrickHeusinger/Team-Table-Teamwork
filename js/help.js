            ...
            <div class="taskinnerwindow">
                <div class="hcontactposition">
                    ...
                    <div class="tutorialstyle">                
                        ...
                        <a class="tutorialstylelink" href="https://patrickthedeveloper.com/manual-de.pdf" target="_blank">download tutorial german</a>
                        <a class="tutorialstylelink" href="https://patrickthedeveloper.com/manual-en.pdf" target="_blank">download tutorial english</a>
                        <br><br>
                        <div>You can also send us an email.</div><br>
                    </div>    
                    <form class="hcontactstyle" action="https://patrick-heusinger.developerakademie.net/php/send_mail.php" method="POST">       
                        ...
                        <button class="hsubmitbtn" type="submit" required>send mail</button>
                    </form>
                </div>
            </div>
        </div>        
