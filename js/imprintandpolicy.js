function renderImprint() {
    ...
    document.getElementById('mainContent').innerHTML = /*html*/ `
        <div class="board">
            <div class="headline">
                <div class="headlinetitle">IMPRINT</div>
            ...
            <div class="taskinnerwindow">
                <div class="imprintContent">
                    <p>According to § 5 TMG</p><p>Patrick Heusinger<br> 
                    Schwarzburgstr. 37<br> 
                    60318 Frankfurt am Main <br> 
                    </p><p> <strong>Represented by: </strong><br>
                    Patrick Heusinger<br>
                    </p><p><strong>Contact:</strong> <br>
                    E-Mail: info@patrickheusinger.de<br>
                </div>
            </div>
        </div>
    `;
...
function renderPolicy() {
    ...
    document.getElementById('mainContent').innerHTML = /*html*/ `
        <div class="board">
            <div class="headline">
                <div class="headlinetitle">POLICY</div>
                <span class="headlinetitletext">Learning Managment System Project</span>
            </div>
            <div id="responsivMain" class="d-none">
                <div class="responsivPosition">
            ...
            <div class="taskinnerwindow">
                <div class="policyContent">
                    ...
                    <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to https://yener-bas.developerakademie.net/Pokedex/index.html.</p>
                    </li>
                    <li>
                    ...
                    <ul>
                    <li>By email: info@patrickheusinger.de</li>
                    </ul>
                </div>   
            </div>
        </div>
